...
class Photometry():
    def __init__(self):
        ...
        self.saturation_limit = 45000 # pixel limit for instrument. HAWKI is 40,000-50,000
...
for filename in image_files:
    ...
    ax2.legend()
    clear_output(wait=False)
    fig.savefig(f'{imgpath}/{name}_{dateobs}_check_position.png')